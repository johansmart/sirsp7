  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li><a href="beranda.php?page=beranda"><i class="fa fa-home"></i> <span>BERANDA</span></a></li>
        <li class="treeview">
          <a href="beranda.php?page=home">
            <i class="fa fa-plus-square-o"></i> <span>MASTER</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="beranda.php?page=pendidikan"><i class="fa fa-legal"></i>Ref Pendidikan</a></li>
            <li><a href="beranda.php?page=spesialis"><i class="fa fa-legal"></i>Ref Spesialis</a></li>
            <li><a href="beranda.php?page=jabatan"><i class="fa fa-legal"></i>Ref Jabatan</a></li>
            <li><a href="beranda.php?page=pekerjaan"><i class="fa fa-legal"></i>Ref Pekerjaan</a></li>
            <li><a href="beranda.php?page=cara_bayar"><i class="fa fa-legal"></i>Ref Cara Bayar</a></li>
            <li><a href="beranda.php?page=berita"><i class="fa fa-legal"></i>Ref Berita</a></li>
            <li><a href="beranda.php?page=fasilitas"><i class="fa fa-legal"></i>Ref Fasilitas</a></li>
             <li><a href="beranda.php?page=bed"><i class="fa fa-legal"></i>Ref Bed</a></li>
          </ul>
        </li>
           <li class="treeview">
          <a href="beranda.php?page=home">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="beranda.php?page=pegawai"><i class="fa fa-child"></i>Input Pegawai</a></li>
            <li><a href="beranda.php?page=filter_dokter"><i class="fa fa-diamond"></i>Jadwal Dokter</a></li>
            <li><a href="beranda.php?page=daftar_dokter"><i class="fa fa-diamond"></i>Daftar Dokter</a></li>
          </ul>
        </li>
         <li class="treeview">
          <a href="beranda.php?page=home">
            <i class="fa fa-plus-square-o"></i> <span>REGISTRASI</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="beranda.php?page=pasien"><i class="fa fa-child"></i>Pasien Baru</a></li>
            <li><a href="beranda.php?page=pasien_lama"><i class="fa fa-diamond"></i>Pasien Lama</a></li>
          </ul>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="beranda.php?page=lap_kunjungan"><i class="fa fa-book"></i>Laporan Kunjungan Pasien</a></li>
              ...
              case 'filter_dokter':
                ...
                case 'edit_jadwal':
                  ...
                  include "modul/pasien/edit_lama.php"; break;
                    ...
                    case 'daftar_pasien':
                  include "modul/pasien/daftar_pasien.php"; break;




                      case 'fasilitas':
                  include "modul/fasilitas/index.php"; break;

                     case 'edit_fasilitas':
                  include "modul/fasilitas/edit.php"; break;
