...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#"" class="logo">
      ...
      <span class="logo-lg"><b>Re</b>gistrasi Online</span>
    </a>
         ...
         <!-- PEMBERITAHUAN -->
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="gambar/login.png" class="user-image" alt="User Image">
              <span class="hidden-xs">AKUN</span>
            </a>
            <ul class="dropdown-menu">
              <li class="user-header">
                  <img src="gambar/login.png" class="img-circle" alt="User Image">
                <h4>Login ini berfungsi jika sudah melakukan registrasi</h4>
                <H5>Harap Klik Login</H5>
<!--            
                <p>
               ADMINISTRATOR
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="login_pasien.php" class="btn btn-default btn-flat">LOGIN SEBAGAI PASIEN</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li><a href="index.php"><i class="fa fa-home"></i> <span>Web Site</span></a></li>
...
<div class="row">
         <?php 
            ...
            if(isset($_GET['page'])){
              ...
              switch ($page) {
              case 'beranda':
                  include "modul_registrasi/sukses/index.php"; break;
              default:
                   include "modul/gagal/index.php";
                  break;
              }
                  }else{
                    include "modul_registrasi/pasien/index.php";
                  }
             ?>
  </div>
</section>
