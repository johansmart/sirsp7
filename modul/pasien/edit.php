            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab_2">
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" id="uraian" name="txtnotelepon" value="<?php echo $data['no_hp']; ?>" placeholder="No Telepon" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')" />
                    </div>
                  </div>
                <div class="form-group">
