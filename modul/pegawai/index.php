            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab_2">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="email"  class="form-control" id="uraian" name="txtemail"  placeholder="Email Contoh : ammashifa@gmail.com">
                  </div>
                </div>
...
if (isset($_GET[hapus])){
  ...
  if ($qry){
  $simpan_log = mysqli_query($konek,"INSERT INTO log_pegawai (kode_pegawai,kode_user,action) VALUES ('P00001','admin@gmail.com','Hapus')");
  if ($simpan_log) {
