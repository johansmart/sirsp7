...
<div class="col-md-12">    
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="tab_1">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="hidden" class="form-control" id="uraian" name="txtkode" value="<?php echo $_SESSION['email'] ?>" onkeypress="return hanyaAngka(event)" placeholder="KODE USER" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')" />
                  </div>
                </div>
    ...
    <?php
          if (isset($_POST["btnedit"])){
            ...
            $simpan = mysqli_query($konek,"INSERT INTO log_pegawai (kode_pegawai,kode_user,action,tanggal) VALUES ('$id','$txtkode','Edit','$tgl_action')");
            if ($edit) {  
              if ($simpan) { ?>
              }
