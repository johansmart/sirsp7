        ...
        <?php
          $photo = mysqli_query($konek,"SELECT * FROM tbl_kunjungan");
          $kunjungan = mysqli_num_rows($photo);
        ?>
            <div class="inner">
              <h3><?php echo $kunjungan;?> </h3>

              <p>JUMLAH KUNJUNGAN PASIEN</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
        <?php
          $dokter = mysqli_query($konek,"SELECT * FROM tbl_news");
          $news = mysqli_num_rows($dokter);
        ?>

            <div class="inner">
              <h3><?php echo $news; ?></h3>
              <p>JUMLAH BERITA/NEWS</p>
            </div>
            <div class="icon">
        ...
        <?php
          $spesialis = mysqli_query($konek,"SELECT * FROM tbl_fasilitas");
          $fasilitas = mysqli_num_rows($spesialis);
        ?>

          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo $fasilitas;?> </h3>
   ...
   <div class="col-lg-3 col-xs-6">
        <?php
          $spesialis = mysqli_query($konek,"SELECT * FROM tbl_bed");
          $total_bed = mysqli_num_rows($spesialis);
        ?>
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo $total_bed;?> </h3>
